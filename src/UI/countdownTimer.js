...
const renderTimeSubtitle = (utc, local) => {
	return (
		<div className="pure-g">
			<div className="pure-u-1 pure-u-md-1-2 text-center text-md-end">
				{utc.toString()}
			</div>
			<div className="pure-u-1 pure-u-md-1-2 text-center text-md-start">
				{local.toString()}
			</div>
		</div>
	);
...
const CountdownTimer = (props) => {
	return [
		renderTimeSubtitle(props.utcString, props.localString),
		renderCountdown(props.startTime, props.endTime),
	];
};
